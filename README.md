...
Marketing / landing site for [TigrimOSR](https://github.com/Sompote/TigrimOSR), the open-loop agentic platform. Clean white ChatGPT-style theme with interactive canvas graphics.

## Structure

- `index.html` — single-page site (hero, stats, swarm modes, agent loop YAML, architecture, features, memory chart, screenshots, install, CTA)
